public class Transaction implements java.io.Serializable
{
  ...
  private boolean isCheck = true; //if it is false it will be a deposit, otherwise it is a check 

  public Transaction(int checkNumber) //constructor 1 
  {
    this.checkNumber = checkNumber;
  }

  public Transaction(int checkNumber, String todayDate, String payee, double amount, String reason) //constructor 2 
  {
    this.checkNumber = checkNumber;
